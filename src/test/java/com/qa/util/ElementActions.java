...
/**
 * @author DELL
 * This class has all selenium web Element methods with wait mechanism applied with exception handling
 *
 */
public class ElementActions {
	 ...
	 *
	 *
	 * This method will wait for fluent wait time and when element is visible get the text and return the string value
	 */
